...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const lanyard = await fetch(
    `https://api.lanyard.rest/v1/users/331005037062914050`
...
const Home = (props: Props) => {
  const { data: lanyard } = useUpdatingLanyard(
    "331005037062914050",
    props.lanyard
  );
  ...
  return (
    <>
      ...
      <div className="w-full space-y-5">
        ...
        <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-3">
          <div className="grid w-full grid-cols-2 gap-5 md:grid-cols-1">
            <Twitter />
            <Instagram />
          </div>
          <div className="col-span-1 md:col-span-2">
        ...
        <div className="flex w-full flex-col gap-10 rounded-xl bg-neutral-900 p-10">
          <div>
            <h1 className="font-bold text-glow-neutral-500">guestbook</h1>
            <h1 className="text-xs text-glow-neutral-100">
              Leave a comment below to be on my guestbook forever! It could be
              literally anything, a joke, a quote or even a cool fact.
            </h1>
          </div>
